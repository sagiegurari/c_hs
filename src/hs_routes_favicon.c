...
enum HSServeFlowResponse _hs_routes_favicon_route_serve(struct HSRoute *, struct HSServeFlowParams *);
void _hs_routes_favicon_route_release(struct HSRoute *);
...
enum HSServeFlowResponse _hs_routes_favicon_route_serve(struct HSRoute *route, struct HSServeFlowParams *params)
{
...
void _hs_routes_favicon_route_release(struct HSRoute *route)
{
  if (route == NULL)
  {
    return;
